...
#include "OculusXRHapticClipFactory.generated.h"

UCLASS()
class OCULUSXRHAPTICSEDITOR_API UOculusXRHapticClipFactory : public UFactory, public FReimportHandler
{
	GENERATED_BODY()
public:
	UOculusXRHapticClipFactory();
