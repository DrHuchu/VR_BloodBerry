...
#include "OculusXRHapticsGameInstanceSubsystem.h"
...
void UOculusXRHapticsGameInstanceSubsystem::Initialize(FSubsystemCollectionBase& Collection)
{
	FOculusXRHapticsModule* const HapticsModule = FOculusXRHapticsModule::GetIfLibraryLoaded();
...
void UOculusXRHapticsGameInstanceSubsystem::Deinitialize()
{
	FOculusXRHapticsModule* const HapticsModule = FOculusXRHapticsModule::GetIfLibraryLoaded();
	if (HapticsModule == nullptr)
	{
...
void UOculusXRHapticsGameInstanceSubsystem::OnHeadsetRemoved()
{
	FOculusXRHapticsModule* const HapticsModule = FOculusXRHapticsModule::GetIfLibraryLoaded();
	if (HapticsModule == nullptr)
	{
...
void UOculusXRHapticsGameInstanceSubsystem::OnHeadsetPutOn()
{
	FOculusXRHapticsModule* const HapticsModule = FOculusXRHapticsModule::GetIfLibraryLoaded();
	if (HapticsModule == nullptr)
	{
