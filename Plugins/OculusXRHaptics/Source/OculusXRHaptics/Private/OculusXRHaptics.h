...
OCULUSXRHAPTICS_API DECLARE_LOG_CATEGORY_EXTERN(LogHapticsSDK, Log, All);
 ...
 */
class OCULUSXRHAPTICS_API FOculusXRHapticsModule : public IModuleInterface
{
public:
	/**
	 * Returns the module, loading it on demand if needed.
	 */
	static FOculusXRHapticsModule& Get()
	{
		return FModuleManager::LoadModuleChecked<FOculusXRHapticsModule>("OculusXRHaptics");
	}
	 ...
	 */
	static FOculusXRHapticsModule* GetIfLibraryLoaded();
