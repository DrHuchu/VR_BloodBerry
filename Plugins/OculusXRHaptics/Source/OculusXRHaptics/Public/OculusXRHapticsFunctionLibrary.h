...
#include "OculusXRHapticsFunctionLibrary.generated.h"

class UOculusXRHapticsPlayerComponent;

UCLASS()
class OCULUSXRHAPTICS_API UOculusXRHapticsFunctionLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()

public:
	/**
	 * Spawns a UOculusXRHapticsPlayerComponent and attaches it to an Actor.
	 *
	 ...
	 *
	 * @return A UOculusXRHapticsPlayerComponent that plays back the haptic clip, and can be used to
	 *         control playback.
	 */
	UFUNCTION(BlueprintCallable, Category = "OculusXR|Haptics", meta = (AdvancedDisplay = "3"))
	static UOculusXRHapticsPlayerComponent* SpawnHapticsPlayerComponent(
